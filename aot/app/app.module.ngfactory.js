...
var AppModuleInjector = (function (_super) {
    ...
    function AppModuleInjector(parent) {
        ...
        ], [import47.EventsAppComponentNgFactory]) || this;
    }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_NgProbeToken_29", {
        get: function () {
            if ((this.__NgProbeToken_29 == null)) {
                (this.__NgProbeToken_29 = [import8.routerNgProbeToken()]);
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_RadioControlRegistry_39", {
        get: function () {
            if ((this.__RadioControlRegistry_39 == null)) {
                (this.__RadioControlRegistry_39 = new import23.RadioControlRegistry());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_BrowserXhr_40", {
        get: function () {
            if ((this.__BrowserXhr_40 == null)) {
                (this.__BrowserXhr_40 = new import24.BrowserXhr());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_ResponseOptions_41", {
        get: function () {
            if ((this.__ResponseOptions_41 == null)) {
                (this.__ResponseOptions_41 = new import25.BaseResponseOptions());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_XHRBackend_43", {
        get: function () {
            if ((this.__XHRBackend_43 == null)) {
                (this.__XHRBackend_43 = new import26.XHRBackend(this._BrowserXhr_40, this._ResponseOptions_41, this._XSRFStrategy_42));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_RequestOptions_44", {
        get: function () {
            if ((this.__RequestOptions_44 == null)) {
                (this.__RequestOptions_44 = new import27.BaseRequestOptions());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_FormBuilder_46", {
        get: function () {
            if ((this.__FormBuilder_46 == null)) {
                (this.__FormBuilder_46 = new import28.FormBuilder());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_LocationStrategy_49", {
        get: function () {
            if ((this.__LocationStrategy_49 == null)) {
                (this.__LocationStrategy_49 = import8.provideLocationStrategy(this.parent.get(import61.PlatformLocation), this.parent.get(import62.APP_BASE_HREF, null), this._ROUTER_CONFIGURATION_48));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_NgModuleFactoryLoader_53", {
        get: function () {
            if ((this.__NgModuleFactoryLoader_53 == null)) {
                (this.__NgModuleFactoryLoader_53 = new import32.SystemJsNgModuleLoader(this._Compiler_20, this.parent.get(import32.SystemJsNgModuleLoaderConfig, null)));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_Router_54", {
        get: function () {
            if ((this.__Router_54 == null)) {
                (this.__Router_54 = import8.setupRouter(this._ApplicationRef_19, this._UrlSerializer_51, this._RouterOutletMap_52, this._Location_50, this, this._NgModuleFactoryLoader_53, this._Compiler_20, this._ROUTES_47, this._ROUTER_CONFIGURATION_48, this.parent.get(import63.UrlHandlingStrategy, null), this.parent.get(import64.RouteReuseStrategy, null)));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_ActivatedRoute_55", {
        get: function () {
            if ((this.__ActivatedRoute_55 == null)) {
                (this.__ActivatedRoute_55 = import8.rootRoute(this._Router_54));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_PreloadAllModules_59", {
        get: function () {
            if ((this.__PreloadAllModules_59 == null)) {
                (this.__PreloadAllModules_59 = new import33.PreloadAllModules());
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_ROUTER_INITIALIZER_60", {
        get: function () {
            if ((this.__ROUTER_INITIALIZER_60 == null)) {
                (this.__ROUTER_INITIALIZER_60 = import8.getBootstrapListener(this._RouterInitializer_14));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_EventService_62", {
        get: function () {
            if ((this.__EventService_62 == null)) {
                (this.__EventService_62 = new import34.EventService(this._Http_45));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_TOASTR_TOKEN_63", {
        get: function () {
            if ((this.__TOASTR_TOKEN_63 == null)) {
                (this.__TOASTR_TOKEN_63 = undefined);
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_JQ_TOKEN_64", {
        get: function () {
            if ((this.__JQ_TOKEN_64 == null)) {
                (this.__JQ_TOKEN_64 = undefined);
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_EventResolver_65", {
        get: function () {
            if ((this.__EventResolver_65 == null)) {
                (this.__EventResolver_65 = new import35.EventResolver(this._EventService_62));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_EventListResolver_66", {
        get: function () {
            if ((this.__EventListResolver_66 == null)) {
                (this.__EventListResolver_66 = new import36.EventListResolver(this._EventService_62));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_VoterService_67", {
        get: function () {
            if ((this.__VoterService_67 == null)) {
                (this.__VoterService_67 = new import37.VoterService(this._Http_45));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_AuthService_68", {
        get: function () {
            if ((this.__AuthService_68 == null)) {
                (this.__AuthService_68 = new import38.AuthService(this._Http_45));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_canDeactivateCreateEvent_69", {
        get: function () {
            if ((this.__canDeactivateCreateEvent_69 == null)) {
                (this.__canDeactivateCreateEvent_69 = import1.checkDirtyState);
            }
    ...
    AppModuleInjector.prototype.createInternal = function () {
        ...
        this._ROUTER_FORROOT_GUARD_7 = import8.provideForRootGuard(this.parent.get(import65.Router, null));
        ...
        this._ApplicationRef__18 = new import13.ApplicationRef_(this.parent.get(import52.NgZone), this.parent.get(import66.Console), this, this._ErrorHandler_13, this, this._ApplicationInitStatus_16, this.parent.get(import12.TestabilityRegistry, null), this._Testability_17);
    ...
    AppModuleInjector.prototype.getInternal = function (token, notFoundResult) {
        ...
        if ((token === import67.ErrorHandler)) {
        ...
        if ((token === import34.EventService)) {
            return this._EventService_62;
        }
        if ((token === import79.TOASTR_TOKEN)) {
            return this._TOASTR_TOKEN_63;
        }
        if ((token === import80.JQ_TOKEN)) {
            return this._JQ_TOKEN_64;
        }
        if ((token === import35.EventResolver)) {
            return this._EventResolver_65;
        }
        if ((token === import36.EventListResolver)) {
            return this._EventListResolver_66;
        }
        if ((token === import37.VoterService)) {
            return this._VoterService_67;
        }
        if ((token === import38.AuthService)) {
            return this._AuthService_68;
        }
        if ((token === 'canDeactivateCreateEvent')) {
            return this._canDeactivateCreateEvent_69;
        }
